...
const Banner = () => {
    ...
    return (
      ...
      >
        ...
        <div className=" absolute top-[15%] lg:top-[45%] w-[400px] lg:w-[800px] rounded-xl  md:left-[23%] bg-black opacity-50  px-4 py-2 lg:py-6">
                <h1 className="text-white text-2xl lg:text-[36px] md:mb-2 lg:mb-10 font-bold text-center">Get the best real estate deals first,
                    </h1>
