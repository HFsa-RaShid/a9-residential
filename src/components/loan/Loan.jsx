...
const Loan = () => {
    ...
    return (
        <div className="relative h-[400px] mb-20 mt-20 rounded-2xl" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${loanImageUrl})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
