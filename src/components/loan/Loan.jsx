...
const Loan = () => {
    ...
    return (
        <div className="relative h-[400px] mb-20 mt-20 rounded-2xl" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${loanImageUrl})`, backgroundSize: 'cover', backgroundPosition: 'center' }} data-aos = "fade-up">
            <div className="md:w-[50%] absolute top-28 left-[25%]" data-aos = "fade-down">
